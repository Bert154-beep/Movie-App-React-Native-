    ...
    <SafeAreaView className='bg-[#1E1E1E] w-full h-full'>
      ...
      <View className='flex flex-row w-full justify-between'>
        <View className='p-5 flex flex-row items-center justify-end  gap-2'>
          ...
          <Text className='text-lg font-bold text-white'>{User?.fullName || "Loading..."}</Text>
        </View>
        <View className='p-5'>
      ...
      <View>
        <View className='p-5 gap-2'>
          ...
          <View className='bg-[#1E1E1E] border-2 border-white w-[330px] rounded-2xl p-3'><Text className='text-[#99A1AA]'>{User?.fullName || "Loading..."}</Text></View>
        </View>
        <View className='p-5 gap-2'>
          <Text className='text-white font-bold text-xl'>Email</Text>
          <View className='bg-[#1E1E1E] border-2 border-white  w-[330px] rounded-2xl p-3'><Text className='text-[#99A1AA]'>{User?.Email || "Loading..."}</Text></View>
        </View>
        <View className='p-5 flex items-center justify-center'><TouchableOpacity onPress={handleDelete} className='w-[330px] p-5 flex items-center justify-center rounded-3xl bg-red-600'><Text className='font-bold text-white text-lg'>Delete Account</Text></TouchableOpacity></View>
      </View>
    </SafeAreaView>
  )
}
